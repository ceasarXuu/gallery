...
final class SessionSeedConversationRepository implements selfgemma.talk.domain.roleplay.repository.ConversationRepository {
    ...
    public SessionSeedConversationRepository() {
        super();
    }
