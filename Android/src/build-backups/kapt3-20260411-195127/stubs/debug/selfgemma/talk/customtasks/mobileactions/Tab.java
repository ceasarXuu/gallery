...
final class Tab {
    ...
    @org.jetbrains.annotations.NotNull()
    public final selfgemma.talk.customtasks.mobileactions.Tab copy(@androidx.annotation.StringRes()
    int labelResId, @org.jetbrains.annotations.NotNull()
    androidx.compose.ui.graphics.vector.ImageVector icon) {
        return null;
    }
